...
api: "GET https://server.smartlead.ai/api/v1/campaigns/"
description: "Retrieves all email campaigns for the authenticated user with comprehensive campaign data including status, schedule set"
---
...
<ParamField query="include_tags" default="false" type="boolean">
...
```json Response (Actual from API - Direct Array)
[
  {
    "id": 2710262,
    "user_id": 196026,
