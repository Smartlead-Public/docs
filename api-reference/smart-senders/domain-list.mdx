...
api: "GET https://server.smartlead.ai/api/smart-senders/domains"
...
```bash cURL
curl "https://server.smartlead.ai/api/smart-senders/domains?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://server.smartlead.ai/api/smart-senders/domains",
...
const response = await fetch(
  `https://server.smartlead.ai/api/smart-senders/domains?api_key=${API_KEY}`
);
