...
api: "GET https://smartdelivery.smartlead.ai/api/v1/spam-test/folder/{folderId}"
...
```bash cURL
curl "https://smartdelivery.smartlead.ai/api/v1/spam-test/folder/{folderId}?api_key=YOUR_KEY"
```
