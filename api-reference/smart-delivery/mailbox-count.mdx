---
title: "Mailbox Count"
api: "GET https://server.smartlead.ai/api/v1/smart-delivery/mailbox-count"
...
response = requests.get(
    "https://server.smartlead.ai/api/v1/smart-delivery/mailbox-count",
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/smart-delivery/mailbox-count?api_key=${API_KEY}`
);
