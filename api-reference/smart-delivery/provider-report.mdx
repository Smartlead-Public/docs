...
api: "POST https://smartdelivery.smartlead.ai/api/v1/spam-test/report/{spamTestId}/providerwise"
...
response = requests.post(
    "https://smartdelivery.smartlead.ai/api/v1/spam-test/report/{spamTestId}/providerwise",
