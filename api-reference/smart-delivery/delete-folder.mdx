---
title: "Delete Folder"
api: "DELETE https://smartdelivery.smartlead.ai/api/v1/spam-test/folder/{folderId}"
...
```bash cURL
curl -X DELETE "https://smartdelivery.smartlead.ai/api/v1/spam-test/folder/{folderId}?api_key=YOUR_KEY"
```
...
response = requests.delete(
    "https://smartdelivery.smartlead.ai/api/v1/spam-test/folder/{folderId}",
