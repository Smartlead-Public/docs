...
api: "POST https://server.smartlead.ai/api/smart-delivery/delete-bulk"
...
```bash cURL
curl -X POST "https://server.smartlead.ai/api/smart-delivery/delete-bulk?api_key=YOUR_KEY" \
...
response = requests.post(
    "https://server.smartlead.ai/api/smart-delivery/delete-bulk",
...
const response = await fetch(
  `https://server.smartlead.ai/api/smart-delivery/delete-bulk?api_key=${API_KEY}`,
  {
    method: 'POST',
