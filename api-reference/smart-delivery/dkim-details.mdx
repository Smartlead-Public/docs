---
title: "DKIM Details"
api: "GET https://server.smartlead.ai/api/smart-delivery/dkim"
...
```bash cURL
curl "https://server.smartlead.ai/api/smart-delivery/dkim?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://server.smartlead.ai/api/smart-delivery/dkim",
...
const response = await fetch(
  `https://server.smartlead.ai/api/smart-delivery/dkim?api_key=${API_KEY}`
);
