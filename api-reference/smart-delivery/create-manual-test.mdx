...
api: "POST https://smartdelivery.smartlead.ai/api/v1/spam-test/manual"
...
response = requests.post(
    "https://smartdelivery.smartlead.ai/api/v1/spam-test/manual",
...
const response = await fetch(
  `https://smartdelivery.smartlead.ai/api/v1/spam-test/manual?api_key=${API_KEY}`,
  {
    method: 'POST',
