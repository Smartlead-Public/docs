---
title: "SPF Details"
api: "GET https://server.smartlead.ai/api/smart-delivery/spf"
...
```bash cURL
curl "https://server.smartlead.ai/api/smart-delivery/spf?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://server.smartlead.ai/api/smart-delivery/spf",
...
const response = await fetch(
  `https://server.smartlead.ai/api/smart-delivery/spf?api_key=${API_KEY}`
);
