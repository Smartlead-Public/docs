...
api: "GET https://smartdelivery.smartlead.ai/api/v1/spam-test/report/{spamTestId}/schedule-history"
...
response = requests.get(
    "https://smartdelivery.smartlead.ai/api/v1/spam-test/report/{spamTestId}/schedule-history",
...
const response = await fetch(
  `https://smartdelivery.smartlead.ai/api/v1/spam-test/report/{spamTestId}/schedule-history?api_key=${API_KEY}`
);
