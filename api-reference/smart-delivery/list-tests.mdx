...
api: "POST https://smartdelivery.smartlead.ai/api/v1/spam-test/report"
...
response = requests.post(
    "https://smartdelivery.smartlead.ai/api/v1/spam-test/report",
...
const response = await fetch(
  `https://smartdelivery.smartlead.ai/api/v1/spam-test/report?api_key=${API_KEY}`,
  {
    method: 'POST',
