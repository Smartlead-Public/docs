...
api: "GET https://server.smartlead.ai/api/smart-delivery/reply-headers"
...
```bash cURL
curl "https://server.smartlead.ai/api/smart-delivery/reply-headers?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://server.smartlead.ai/api/smart-delivery/reply-headers",
...
const response = await fetch(
  `https://server.smartlead.ai/api/smart-delivery/reply-headers?api_key=${API_KEY}`
);
