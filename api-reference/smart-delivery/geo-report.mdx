...
api: "POST https://smartdelivery.smartlead.ai/api/v1/spam-test/report/{spamTestId}/groupwise"
...
response = requests.post(
    "https://smartdelivery.smartlead.ai/api/v1/spam-test/report/{spamTestId}/groupwise",
...
const response = await fetch(
  `https://smartdelivery.smartlead.ai/api/v1/spam-test/report/{spamTestId}/groupwise?api_key=${API_KEY}`,
  {
    method: 'POST',
