...
description: "List all email accounts with filtering and pagination"
---
...
```bash cURL
curl "https://server.smartlead.ai/api/v1/email-accounts/?api_key=YOUR_KEY"
```
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/email-accounts/?api_key=${API_KEY}`
);
