---
title: "Get Campaign Lead by ID"
api: "GET https://server.smartlead.ai/api/v1/campaigns/{campaign_id}/leads/{lead_id}"
description: "Retrieve detailed information about a specific lead in a campaign"
---
...
response = requests.get(
    f"https://server.smartlead.ai/api/v1/campaigns/123/leads/789",
