...
description: "Change the status of a campaign (start, pause, stop). Updates campaign status to START, PAUSE, or STOP. Starting a campaign triggers validation of sequences, email accounts, and leads before activation."
---
