...
description: "Creates a new email campaign with default settings in DRAFTED status. Campaign name defaults to 'Untitled Campaign' if not provided. Automatically associates with client_id for client API keys. Returns campaign ID and metadata."
---
