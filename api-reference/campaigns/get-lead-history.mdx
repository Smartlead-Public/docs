...
api: "GET https://server.smartlead.ai/api/v1/campaigns/{campaign_id}/leads/{lead_id}/message-history"
description: "Retrieve complete email conversation history for a specific lead"
---
