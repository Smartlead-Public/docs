...
api: "POST https://server.smartlead.ai/api/v1/campaigns/{campaign_id}/leads/{lead_id}/category"
description: "Assign or change the category for a lead within a campaign"
---
