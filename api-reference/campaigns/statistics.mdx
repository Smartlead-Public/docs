  ...
  "data": [
    {
      ...
      "sequence_number": 1,
      "stats_id": "002e2906-67ec-4ef0-bc99-68b78eece118",
      "email_campaign_seq_id": 15884,
      "seq_variant_id": 4102,
      "email_subject": "Quick question",
      "email_message": "<div>Hi Jane</div>",
      "sent_time": "2025-11-06T09:15:00.000Z",
      "open_time": null,
      "click_time": null,
      "reply_time": null,
      "open_count": 0,
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Statistics Object">
    ...
    <ResponseField name="sender_bounce" type="boolean">
      `true` when this email bounced **because of the sending mailbox** rather than the recipient address, i.e. the email bounced and its lead is categorised as Sender Originated Bounce. Always a boolean. A `true` here always has `is_bounced: true`.
    </ResponseField>
  </Expandable>
</ResponseField>
