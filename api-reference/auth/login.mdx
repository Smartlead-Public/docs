---
title: "Login"
api: "POST https://server.smartlead.ai/api/auth/login"
description: ""
---
...
```bash cURL
curl -X POST "https://server.smartlead.ai/api/auth/login?api_key=YOUR_KEY" \
...
const response = await fetch(
  `https://server.smartlead.ai/api/auth/login?api_key=${API_KEY}`,
  {
    method: 'POST',
