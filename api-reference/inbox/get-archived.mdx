---
title: "Get Archived Messages"
api: "POST https://server.smartlead.ai/api/v1/master-inbox/archived"
description: "Retrieve archived conversations with filtering by campaign and categories"
---
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/master-inbox/archived?api_key=${API_KEY}`,
  {
    method: 'POST',
