---
title: "Verify Email"
api: "POST https://server.smartlead.ai/api/verify-email/list"
...
response = requests.post(
    "https://server.smartlead.ai/api/verify-email/list",
...
const response = await fetch(
  `https://server.smartlead.ai/api/verify-email/list?api_key=${API_KEY}`,
  {
    method: 'POST',
