...
description: "Comprehensive domain and email block list management."
---
<Note>
...
Comprehensive domain and email block list management
...
```bash cURL
curl "https://server.smartlead.ai/api/v1/leads/get-domain-block-list?api_key=YOUR_KEY&offset=0&limit=100&filter_client_id=1&filter_email_or_domain=example.com"
```
...
response = requests.get(
    ...
    params={
        ...
        "limit": 100,
        "filter_client_id": 1,
        "filter_email_or_domain": "example.com"
    }
)
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/leads/get-domain-block-list?api_key=${API_KEY}&offset=0&limit=100&filter_client_id=1&filter_email_or_domain=example.com`
);
...
```bash cURL
curl -X DELETE "https://server.smartlead.ai/api/v1/leads/delete-domain-block-list?api_key=YOUR_KEY&id=123"
```
...
response = requests.delete(
    "https://server.smartlead.ai/api/v1/leads/delete-domain-block-list",
    params={
        "api_key": API_KEY,
        "id": block_list_id
    }
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/leads/delete-domain-block-list?api_key=${API_KEY}&id=${blockListId}`,
  { method: 'DELETE' }
);
