...
api: "GET https://server.smartlead.ai/api/v1/leads/fetch-categories"
description: "Retrieve all available lead categories including global and user-specific categories"
---
