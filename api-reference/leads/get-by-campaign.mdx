...
description: "Retrieve all leads in a campaign"
---
...
```bash cURL
curl "https://server.smartlead.ai/api/v1/campaigns/{campaign_id}/leads?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://server.smartlead.ai/api/v1/campaigns/{campaign_id}/leads",
